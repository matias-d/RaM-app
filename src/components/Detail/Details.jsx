      ...
      <div className={styles.container}>
        ...
        <div className={styles.detail__info}>
          ...
          <div className={styles.info__characteristics}>
            ...
            <p className={styles.characteristics__genre}><RiParentLine className={styles.characteristics__iconGenre} /> Genero : <span className={styles.genre__info}>{character.gender}</span></p>
          </div>
        </div>
      </div>
      <svg
        ...
        style={{ fill: '#DBF227', width: '100%', height: 30, transform: 'rotate(180deg)' }}
      >
        <path
